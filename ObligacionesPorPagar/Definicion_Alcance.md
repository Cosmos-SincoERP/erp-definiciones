...
| **Partida en Disputa** | Marca especial para partidas del extracto bancario que no pueden conciliarse debido a errores bancarios, fraudes potenciales o transacciones no reconocidas. Permite alcanzar el 100% de conciliación operativa sin generar anticipos. Su resolución posterior puede ser: (1) **Descartada:** la partida específica dentro de la OXP de Extracto se marca como descartada cuando el banco reversa o la reclamación se resuelve; (2) **Conciliación posterior:** cuando se identifica el gasto y se radica la OXP de Comercio correspondiente, la partida se concilia y se genera una segunda OXP de Extracto para agrupar estas partidas resueltas. |
...
| **Manejo de Diferencia en Cambio** | Para cada OXP de Comercio en moneda extranjera, si existe diferencia entre el valor radicado (TRM del día de la transacción) y el valor en el extracto (TRM del día de corte), el sistema genera automáticamente movimientos contables de ajuste por diferencia en cambio **sobre la OXP de Extracto**. Se genera un ajuste por cada OXP de Comercio en moneda extranjera. Esto permite el cruce exacto sin crear nuevas OXP. |
...
| **Salida - Conciliación exitosa** | OXP de Comercio en estado **Compensada** vinculadas a la OXP de Extracto en estado **Conciliada**. Para cada OXP de Comercio en moneda extranjera con diferencia de cambio, se incluyen los movimientos de ajuste correspondientes sobre la OXP de Extracto. |
...
| **Salida - Partida en Disputa** | La marca de "Partida en Disputa" permite alcanzar el 100% de conciliación operativa sin generar anticipos. Posteriormente, la partida en disputa (dentro de la OXP de Extracto) puede resolverse de dos formas: (1) **Descartada:** cuando el banco realiza el reverso o la reclamación se resuelve a favor de la compañía, la partida específica se marca como descartada y cierra su ciclo; (2) **Conciliación posterior:** cuando se identifica el gasto real y se radica la OXP de Comercio correspondiente, la partida se concilia y se genera una **segunda OXP de Extracto** que agrupa estas partidas resueltas posteriormente. |
