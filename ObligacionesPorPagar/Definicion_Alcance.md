...
| **Diferencia en Cambio** | Variación en el valor de una transacción en moneda extranjera ocasionada por fluctuaciones en la TRM entre la fecha de la transacción (radicación) y la fecha de compensación en el extracto. Al momento de la conciliación, el sistema genera automáticamente un **concepto de ajuste por diferencia en cambio** sobre la OXP de Extracto por cada OXP de Comercio en moneda extranjera: si la TRM subió, se clasifica como gasto financiero; si la TRM bajó, se clasifica como ingreso financiero. Estos conceptos permiten el cruce exacto entre la OXP de Comercio y la partida del extracto sin crear una nueva OXP. |
...
| **Salida - Conciliación exitosa** | OXP de Comercio en estado **Compensada** vinculadas a la OXP de Extracto en estado **Conciliada**. Para cada OXP de Comercio en moneda extranjera con diferencia de cambio, se incluyen los conceptos de ajuste correspondientes sobre la OXP de Extracto. |
