...
| `compartido/nuggets/` | Nuggets (value objects transversales empaquetados: identificación legal, dirección, contacto, país, moneda, etc.) | Catálogo + gobernanza — 9 nuggets (replanteamiento #31) |
