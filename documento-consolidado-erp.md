...
- 🟡 Refinamiento en progreso (~85%) — catálogos fiscales F1 entregados (968 entradas CO/DO/PA); #39 (perfil sin registro centralizado), #93 (ICA solo ingreso), #110 (IVA_IMPORTACION_SERVICIOS, resolución con la consultoría fiscal), #111 (matriz de tratamientos alineada a la implementación) y #108 (sobretasa bomberil `anticipado`, validado con las dos consultoras) aplicados; resta el refinamiento por consultores sobre las secciones "Revisión pendiente" (abiertos: #97 cuantía mínima como política y #109 RITBMS de Panamá).
