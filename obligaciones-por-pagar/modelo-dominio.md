...
| Entidad | Descripción | Atributos |
|---|---|---|
| `PartidaExtracto` | Línea individual del extracto bancario. Identidad: posición (índice) en el extracto — permite trazabilidad directa al documento fuente. | Posición, descripción, valor, fecha, estado (pendiente/vinculada/disputa/anticipo/devolucion/descartada). |
