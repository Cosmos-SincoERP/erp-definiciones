...
| 4 | Generar contrapartida: el **tercero** se asigna automáticamente del contexto de la transacción; la **unidad organizacional** se asigna según la preferencia de la empresa [I33] (distribuida replicando las partidas de origen, consolidada en una unidad general, o sin unidad organizacional — respetando la obligatoriedad del PUC). La cuenta auxiliar se resuelve por la cadena como cualquier otro rol; al carecer de `tipoComponente`, su Nivel B se acota al `grupoPucEsperado` declarado a nivel del rol contrapartida [D12]. [R01] | — | — |
...
| **Información capturada** | Partidas (cuenta o null, tercero, unidadOrganizacional, debito, credito, nivelResolucion, rol, esContrapartida, descripcionConcepto), referenciaOrigen, subDominioOrigen, documentoFuente, descripcion, tipoTransaccion, empresa, moneda, fecha. |
