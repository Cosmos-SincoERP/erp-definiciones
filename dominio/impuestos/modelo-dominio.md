...
- **`gasto`**: el tributo solo existe cuando la emisora es adquiriente. Aplica a tributos autoliquidados por reverseCharge (IVA_IMPORTACION_SERVICIOS: el adquiriente asume el IVA al contratar servicios con proveedores sin domicilio fiscal en el país).
