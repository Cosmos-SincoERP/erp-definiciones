...
- **`sustractivo`**: resta del valor a pagar/cobrar (retenciones — una parte retiene a la otra).
...
- **`gasto`**: el tributo solo existe cuando la emisora es adquiriente. Aplica a tributos autoliquidados (IVA_IMPORTACION_SERVICIOS: el adquiriente asume el IVA al contratar servicios con proveedores sin domicilio fiscal en el país — tributo autónomo de naturaleza `provision`).
...
|------|:---------:|:-----------:|:---------------:|:-----:|
| Colombia | 3 (IVA, INC, ICA) | 4 (RETEFUENTE, RIVA, RICA, SOBRETASA_BOMBERIL) | 4 (AUTO_RENTA, AUTO_RETEFUENTE, AUTO_RICA + IVA_IMPORTACION_SERVICIOS autoliquidado) | **11** |
