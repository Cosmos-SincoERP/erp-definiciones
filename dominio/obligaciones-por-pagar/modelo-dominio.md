...
| `MedioDePago` | Tipo (crédito/débito prepago), número, entidad bancaria — copiado del `ProductoFinanciero` atribuido (`[D39]`) |
| `ValorMonetario` | Monto, moneda, TRM (si aplica), monto en moneda funcional |
