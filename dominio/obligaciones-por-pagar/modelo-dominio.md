...
| `UnidadReabierta` | Vuelve a admitir distribuciones nuevas |
...
**Eventos salientes (OXP → EO):**

| Evento de OXP | Propósito en EO |
|---|---|
| Señal de demanda de unidad inexistente (no bloqueante) | Cuando OXP difiere por una unidad que no existe, hace **visible** la necesidad en la bandeja de sugerencias de EO (`[SI11]` de EO) para que el administrador la cree si corresponde. Es informativa: no crea unidades, no bloquea a OXP, y la corrección de OXP no depende de ella (la sostiene el diferir). |
| Imputación a unidad | Cuando OXP imputa a una unidad, informa el hecho a EO, que alimenta su proyección de última imputación (`[SI10]` de EO) — la que EO usa para validar la fecha efectiva de sus reestructuraciones. |
