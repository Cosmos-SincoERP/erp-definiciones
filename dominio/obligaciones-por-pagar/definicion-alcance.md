...
| 1.13 | Junio 2026 | **Consistencia del modelo de comunicación con EO (issue #56).** Se retira la integración saliente *aviso de imputación a unidad* (EO relajó la validación de fecha efectiva — R25/I08 — y ya no mantiene proyección de imputación); OXP solo publica la **señal de demanda** de unidad inexistente. Se añade `reactivada` a la lista de eventos de ciclo de vida que OXP consume por copia local (faltaba; sin ella una unidad reactivada desde suspensión no se reflejaba). Acompaña al modelo v4.1. |
