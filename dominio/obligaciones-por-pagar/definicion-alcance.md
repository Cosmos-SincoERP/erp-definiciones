...
| **Estructura Organizacional** | Aviso de imputación a una unidad (alimenta la proyección de última imputación que Estructura Organizacional usa para sus reestructuraciones) | JSON (eventos) | Publicación de eventos |
